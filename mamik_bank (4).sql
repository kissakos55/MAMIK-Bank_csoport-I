...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 03. 10:57
...
--
CREATE DATABASE IF NOT EXISTS `mamik_bank` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `mamik_bank`;
...
(1, 'a', 'Lakatos Iván', 'jQGX8grO1yjNqhiZbtROcseiqj1NVZJd2iqlfxPx1GKLJ9H8smnLJ9dloScCK6Zp', 'dcedbd2d352d19c6eae0dfb12271b74d985c825b8d774afd2abd0d101b6e57ef', 'lakatosi@gmail.com', 9, 1, '2024-11-25 07:33:49', 'szandi.jpg'),
...
(21, 'Orb', 'Nagy Viktor', 'vMWrzZwNfDX5bIg0PKjKguuDvef69vlb6AI24kmItYmsQdtjbVfjKSXjYdVEVkEZ', '68f06939e72ab57042172dbc63bb6d03a4289d274c86cc173012d1e56ae35b3a', 'minkad@kkszki.hu', 1, 0, '2025-03-11 09:08:14', 'default.jpg');
...
--
-- A tábla adatainak kiíratása `hitelkartyak`
--

INSERT INTO `hitelkartyak` (`Id`, `kartya_azonosito`, `ugyfel_azonosito`, `kartyaszam`, `lejarati_datum`, `CVV_kod`, `hitelkeret`, `elerheto_hitelkeret`) VALUES
(2, 12, 1, 2345665, '2028-02-10', 376, 200, 120);
...
CREATE TABLE `szamlak` (
  ...
  `szamlaszam` int(30) NOT NULL,
  `megtakaritas` int(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `szamlak` (`Id`, `szamla_azonosito`, `ugyfel_azonosito`, `szamlatipus`, `penznem`, `egyenleg`, `nyitasi_datum`, `statusz`, `szamlaszam`, `megtakaritas`) VALUES
(3, 1, 1, 'megtakaritas', 'Ft', 40000, '2025-02-04', '', 1223865723, 0);
...
(1, 0, 1, 'megtakaritas', 2000, '2025-02-04', 0, ''),
(3, 23, 1, 'megtakaritas', 100, '2025-02-12', 0, '');
...
(1, 1, 'Lakatos István', '1999-02-09', '72263873', 'Kelet utca 4.', 'lakatosi@gmail.com', 670234, '2024-11-25'),
(2, 21, 'Orban ', '1987-02-03', '', 'Soltész Nagy Kálmán utca.5', 'maklarig@gmail.com', 33445, '2025-03-11');
...
ALTER TABLE `tranzakciok`
  ...
  ADD KEY `szamla_azonosito` (`szamla_azonosito`) USING BTREE;
